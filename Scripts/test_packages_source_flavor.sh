...
extract_function_body "apply_luci_feed_25_12_package_overrides" | grep -q 'update_package_list "luci-app-vlmcsd vlmcsd" "sbwml/openwrt_pkgs" "main"'
extract_function_body "apply_luci_feed_25_12_package_overrides" | grep -q 'update_package_list "luci-app-socat" "sbwml/openwrt_pkgs" "main"'
