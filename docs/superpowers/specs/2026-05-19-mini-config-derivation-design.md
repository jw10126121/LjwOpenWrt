...
- `Config/MT6000-WIFI-MINI-FW3.txt`
...
- `Config/MT6000-WIFI-FW3.txt`
- `Config/MT6000-WIFI-FW4.txt`
...
- `Config/device-overlays/MT6000-WIFI-MINI-FW3.txt`
- `Config/device-overlays/MT6000-WIFI-MINI-FW4.txt`
...
`IPQ60XX-NOWIFI-MINI`、`MT6000-WIFI-MINI`、`MIR3G-WIFI-MINI` 允许保留少量显式特例。例如：
...
- `Scripts/tests/test_mt6000_mini_fw3_export.sh`
...
- `MT6000-WIFI-MINI` 导出结果中，允许的模块包仍只来自显式特例
...
4. 提取 `MT6000-WIFI-MINI` 的 `FW3` / `FW4` 特例 overlay
