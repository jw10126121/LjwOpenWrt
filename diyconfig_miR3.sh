...
# 修改wifi名
sed -i 's/set wireless.default_radio\${devidx}.ssid=OpenWrt/set wireless.default_radio\${devidx}.ssid=openwrt/g' $package_root/kernel/mac80211/files/lib/wifi/mac80211.sh
# 修改wifi密码
sed -i 's/set wireless.default_radio\${devidx}.encryption=none/set wireless.default_radio\${devidx}.encryption=psk-mixed \n\t\t\t set wireless.default_radio\${devidx}.key=1234567890/g' $package_root/kernel/mac80211/files/lib/wifi/mac80211.sh
